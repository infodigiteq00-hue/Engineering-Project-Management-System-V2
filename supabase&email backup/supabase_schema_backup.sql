...
CREATE TABLE IF NOT EXISTS public.users (
  ...
  CONSTRAINT fk_users_project FOREIGN KEY (project_id) REFERENCES public.projects(id)
);
...
CREATE TABLE IF NOT EXISTS public.equipment (
  ...
  notes text,
  progress_images ARRAY DEFAULT '{}'::text[],
...
CREATE TABLE IF NOT EXISTS public.vdcr_records (
  ...
  equipment_tag_numbers ARRAY NOT NULL,
  mfg_serial_numbers ARRAY NOT NULL,
  job_numbers ARRAY NOT NULL,
...
-- ============================================================================
-- Total: 25 Tables + 4 Storage Buckets
